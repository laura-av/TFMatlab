...
figure(1)
%subplot(2,5,1)
plot(times, y(:,1),'-', 'LineWidth', 1.8) % Uninfected
hold on
plot(times, y(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(times, y(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(times, y(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
...
title('HIV Model','FontSize',14); xlabel('Time','FontSize',13); ylabel('Population','FontSize',13);
hold off
...
% % Graphics
 figure(2)
subplot(3,3,1)
plot(timesp, yp(:,1),'-', 'LineWidth', 1.8) %Uninfected cells
hold on
plot(timesp, yp(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timesp, yp(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timesp, yp(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_p","Tm'_p","Tw'_p","Tmw'_p", "Location","best")
title('Derivate p HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(3)
subplot(3,3,2)
plot(timespm, ypm(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timespm, ypm(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timespm, ypm(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timespm, ypm(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{pm}","Tm'_{pm}","Tw'_{pm}","Tmw'_{pm}", "Location","best")
title('Derivate pm HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(4)
subplot(3,3,3)
plot(timespw, ypw(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timespw, ypw(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timespw, ypw(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timespw, ypw(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{pw}","Tm'_{pw}","Tw'_{pw}","Tmw'_{pw}",  "Location","best")
title('Derivate pw HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(5)
subplot(3,3,4)
plot(timespmw, ypmw(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timespmw, ypmw(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timespmw, ypmw(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timespmw, ypmw(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{pmw}","Tm'_{pmw}","Tw'_{pmw}","Tmw'_{pmw}", "Location","best")
title('Derivate pmw HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(6)
subplot(3,3,5)
plot(timeskm, ykm(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timeskm, ykm(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timeskm, ykm(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timeskm, ykm(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{km}","Tm'_{km}","Tw'_{km}","Tmw'_{km}", "Location","best")
title('Derivate km HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(7)
subplot(3,3,6)
plot(timeskw, ykw(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timeskw, ykw(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timeskw, ykw(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timeskw, ykw(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{kw}","Tm'_{kw}","Tw'_{kw}","Tmw'_{kw}",  "Location","best")
%"T0_{kw}","Tm0_{kw}", "Tw0_{kw}", "Tmw0_{kw}"
title('Derivate kw HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(8)
subplot(3,3,7)
plot(timeskR, ykR(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timeskR, ykR(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timeskR, ykR(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timeskR, ykR(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{kR}","Tm'_{kR}","Tw'_{kR}","Tmw'_{kR}", "Location","best")
title('Derivate kR HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
% figure(9)
subplot(3,3,8)
plot(timesqm, yqm(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timesqm, yqm(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timesqm, yqm(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timesqm, yqm(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{qm}","Tm'_{qm}","Tw'_{qm}","Tmw'_{qm}", "Location","best")
title('Derivate qm HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
...
%figure(10)
subplot(3,3,9)
plot(timesqw, yqw(:,1),'-', 'LineWidth', 1.8) % Uninfected cells
hold on
plot(timesqw, yqw(:,2),'--', 'LineWidth', 2.1) % Mutant infected cells
plot(timesqw, yqw(:,3),':', 'LineWidth', 1.9) % Wild-type infected cells
plot(timesqw, yqw(:,4),'-.', 'LineWidth', 1.8) % Dual infected cells
plot(0,y00(1), 'k.', 'MarkerSize',18)
plot([0,TT], [0,0], 'k:', 'LineWidth', 0.5)
legend("T'_{qw}","Tm'_{qw}","Tw'_{qw}","Tmw'_{qw}",  "Location","best")
title('Derivate qw HIV Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
