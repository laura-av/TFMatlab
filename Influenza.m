...
figure(1)
subplot(2,3,1)
plot(times, y(:,1), 'r-', 'LineWidth', 1.8) % Uninfected target cells
hold on
plot(times, y(:,2), 'g-', 'LineWidth', 1.8) % Productively infected cells
plot(times, y(:,3), 'b--', 'LineWidth', 1.8) % Infectious viral titer
plot(0,T0, 'c.', 'MarkerSize',18)
plot(0,I0, 'k.', 'MarkerSize',18)
plot(0,V0, 'y.', 'MarkerSize',18)
legend("T","I","V","T0","I0", "V0",  "Location","best")
title('Influenza Model','FontSize',14); xlabel('Time','FontSize',13); ylabel('Population','FontSize',13);
hold off
...
% figure(2)
subplot(2,3,2)
plot(timesb, yb(:,1),'r-' ,'LineWidth', 1.8)
hold on
plot(timesb, yb(:,2),'g-' ,'LineWidth', 1.8)
plot(timesb, yb(:,3),'b--' ,'LineWidth', 1.8)
...
title('Derivates_\beta Influenza Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
shg
...
% figure(3)
subplot(2,3,3)
plot(timesd, yd(:,1),'r-' ,'LineWidth', 1.8)
hold on
plot(timesd, yd(:,2),'g-' ,'LineWidth', 1.8)
plot(timesd, yd(:,3),'b--' ,'LineWidth', 1.8)
plot(0,0, 'y.', 'MarkerSize',18)
plot([0,TT], [0,0], ':k', 'LineWidth', 0.5)
legend("Derivate T_\delta","Derivate I_\delta","Derivate V_\delta","T_{\delta 0}, I_{\delta0},V_{\delta0}",  "Location","best")
title('Derivates_\delta Influenza Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
shg
...
% figure(4)
subplot(2,3,4)
plot(timesp, yp(:,1),'r-' ,'LineWidth', 1.8)
hold on
plot(timesp, yp(:,2),'g-' ,'LineWidth', 1.8)
plot(timesp, yp(:,3),'b--' ,'LineWidth', 1.8)
plot(0,0, 'y.', 'MarkerSize',18)
plot([0,TT], [0,0], ':k', 'LineWidth', 0.5)
legend("Derivate T_p","Derivate I_p","Derivate V_p","T_{p 0}, I_{p0},V_{p0}",  "Location","best")
title('Derivates_p Influenza Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
shg
...
subplot(2,3,5)
plot(timesc, yc(:,1),'r-' ,'LineWidth', 1.8)
hold on
plot(timesc, yc(:,2),'g-' ,'LineWidth', 1.8)
plot(timesc, yc(:,3),'b--' ,'LineWidth', 1.8)
plot(0,0, 'y.', 'MarkerSize',18)
plot([0,TT], [0,0], ':k', 'LineWidth', 0.5)
legend("Derivate T_c","Derivate I_c","Derivate V_c","T_{c 0}, I_{c0},V_{c0}",  "Location","best")
title('Derivates_c Influenza Model','FontSize',14); xlabel('Time','FontSize',13);
hold off
shg
